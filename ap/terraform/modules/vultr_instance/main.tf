...
runcmd:
  ...
  # install postgres
  - curl -L -O https://raw.githubusercontent.com/brandonros/postgres-adventure/c8f7a96ff5d5d27698f3f91af433fe55cd69cf24/manifests/postgresql.yaml && kubectl apply -f postgresql.yaml && rm postgresql.yaml
EOF
}